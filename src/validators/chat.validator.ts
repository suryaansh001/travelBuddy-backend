...
// Message types
export const MESSAGE_TYPES = ['text', 'image', 'location', 'payment', 'system'] as const;
...
export const sendMessageSchema = z.object({
  ...
  if (data.type === 'location') return data.lat !== undefined && data.lng !== undefined;
  if (data.type === 'payment') return !!data.paymentUrl && !!data.amount;
  return true;
