...
// Trip Types
export const TRIP_TYPES = ['travel_buddy', 'cab_pool'] as const;
export const TRIP_STATUSES = ['open', 'in_progress', 'completed', 'cancelled'] as const;
...
// Gender Preferences
export const GENDER_PREFERENCES = ['any', 'male', 'female', 'same'] as const;
