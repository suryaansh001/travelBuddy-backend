...
import { getChatRoomSchema, sendMessageSchema, getMessagesSchema, markReadSchema, deleteMessageSchema, flagMessageSchema, getMyChatRoomsSchema, } from '../validators/chat.validator.js';
class ChatController {
    ...
    // Flag a message
    async flagMessage(req, res, next) {
        try {
            const userId = req.user.id;
    ...
    async getMyChatRooms(req, res, next) {
        try {
            const userId = req.user.id;
